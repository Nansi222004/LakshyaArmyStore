      ...
      <div className="bg-amber-50 rounded-2xl p-5 border border-amber-200 flex gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-amber-800 font-medium leading-relaxed mt-1">
            Setting reward parameters will immediately apply to user streak progress calculations. Streak days are incremented only when the daily plays goal is met. Make sure repeatable settings match your Mynzo Coin budget policies.
          </p>
        </div>
      </div>
