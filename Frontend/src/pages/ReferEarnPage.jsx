      ...
      {!user || !user.id ? (
        ...
        <div className="p-4 flex-1 flex flex-col gap-4">
          ...
          <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 bg-slate-100 text-slate-700 font-bold py-2.5 rounded-lg border border-slate-200 hover:bg-slate-200 transition-colors"
              >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            {showApply && (
              <div className="px-5 pb-4 flex gap-2 animate-fade-in border-t border-slate-50 pt-3">
                <input
                  type="text"
                  value={applyCode}
