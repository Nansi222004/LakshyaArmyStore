...
export default function HelpSupportPage() {
  ...
  return (
    <div className="bg-slate-50 min-h-[100dvh] font-sans animate-fade-in flex flex-col pb-10">
      {/* Header */}
              ...
              {myTickets.map((ticket) => (
                ...
                >
                  <div className="space-y-1">
                    ...
                    <h4 className="text-xs font-bold text-slate-800 leading-tight">{ticket.subject}</h4>
            ...
            <div className="bg-white w-full max-w-md rounded-t-3xl sm:rounded-2xl p-6 shadow-2xl space-y-4 border border-slate-100 max-h-[80vh] overflow-y-auto animate-in slide-in-from-bottom-10 sm:zoom-in-95 duration-300">
              <div className="flex justify-between items-center border-b border-slate-50 pb-3">
                ...
                <button 
                  ...
                  className="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:text-slate-900 hover:bg-slate-100 active:scale-90 transition-all cursor-pointer font-bold"
                >
                  ✕
                </button>
              </div>
              ...
              <div className="space-y-4 text-xs">
                ...
                <div className="space-y-1.5 pt-2 border-t border-slate-50">
                  ...
                  <p className="text-slate-600 font-medium leading-relaxed bg-slate-50/50 p-4 rounded-xl border border-slate-100/50 whitespace-pre-line text-[11px]">{selectedTicket.description}</p>
                </div>
              </div>
