    ...
    >
      ...
      {activeCommentPost && (
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl h-[60dvh] z-[110] flex flex-col max-w-md mx-auto shadow-2xl animate-in slide-in-from-bottom-full duration-300 font-sans">
            {/* Header */}
                        ...
                        {isEditingThis ? (
                          <div className="mt-1 flex gap-2">
                            <input
                              ...
                              className="flex-1 border border-slate-200 px-3 py-1.5 text-xs font-bold rounded-lg focus:outline-none"
                            />
                            <button 
                            ...
                            <button 
                              ...
                              className="bg-slate-100 text-slate-500 px-2 rounded-lg text-[10px] font-bold"
                            >
                              ✕
                            </button>
                          </div>
                    ...
                    {isMyComment && !isEditingThis && (
                      <div className="flex gap-2 flex-shrink-0">
                        ...
                        <button 
                          ...
                          className="p-1.5 hover:bg-slate-50 text-slate-400 hover:text-red-600 rounded transition-colors"
                        >
            ...
            {/* Add Comment Input */}
            <div className="p-4 border-t border-slate-100 flex items-center gap-2 bg-slate-50 rounded-b-3xl">
      ...
      {shareOverlayPost && (
        <div className="fixed inset-0 bg-black/60 z-[120] flex items-center justify-center p-4 font-sans text-slate-800">
          <div className="bg-white rounded-3xl p-6 w-full max-w-sm space-y-4 shadow-2xl relative">
            <button 
