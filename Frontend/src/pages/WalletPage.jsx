          ...
          <div className="bg-gradient-to-br from-[#2F3E16] to-indigo-900 rounded-[24px] p-5 text-white shadow-lg relative overflow-hidden">
            ...
            <div className="relative z-10 grid grid-cols-2 divide-x divide-white/20">
              ...
              <div className="flex flex-col items-center text-center pr-2">
                <div className="w-10 h-10 bg-white/15 rounded-full flex items-center justify-center mb-2 border border-white/20 shadow-inner">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
                  {coinTransactions.map((tx, idx) => {
                    ...
                    return (
                      <div 
                        key={tx.id} 
                        className={`flex items-center justify-between p-4.5 ${idx !== coinTransactions.length - 1 ? 'border-b border-slate-50' : ''}`}
                      >
                        <div className="flex items-center gap-3">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
                  {walletTransactions.map((tx, idx) => {
                    ...
                    return (
                      <div 
                        key={tx.id} 
                        className={`flex items-center justify-between p-4.5 ${idx !== walletTransactions.length - 1 ? 'border-b border-slate-50' : ''}`}
                      >
                        <div className="flex items-center gap-3">
