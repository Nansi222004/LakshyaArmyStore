    ...
    >
      ...
      <div className="relative aspect-[1/1.1] w-full bg-slate-100">
        ...
        <button 
          ...
          className="absolute top-2 right-2 w-7 h-7 bg-white/90 hover:bg-white text-slate-600 rounded-full flex items-center justify-center shadow-sm z-10 transition-all hover:scale-110 active:scale-95 cursor-pointer"
        >
