        ...
        >
          ...
          {snake.map((segment, index) => {
            ...
            return (
              ...
              >
                {isHead ? (
                  <div className="w-[120%] h-[120%] bg-white rounded-full shadow-lg flex items-center justify-center relative z-20">
                  ...
                  <div className="w-[90%] h-[90%] bg-slate-100 rounded-full shadow-sm z-10"></div>
                )}
              </div>
            );
          })}
        ...
        <div className="mt-6 w-full rounded-3xl border border-slate-700/80 bg-gradient-to-b from-slate-800 to-[#0A1024] p-3 flex flex-col items-center relative overflow-hidden shadow-2xl">
          <div className="flex items-center justify-between w-full relative z-10 gap-2">
            ...
            <div className="relative w-16 h-16 flex-shrink-0">
               <img src={DollMynzo} alt="Doll Mascot" className="w-full h-full object-contain drop-shadow-lg" />
            </div>
