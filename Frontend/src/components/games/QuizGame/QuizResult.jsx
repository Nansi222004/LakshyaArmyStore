...
export default function QuizResult({ score, total, onPlayAgain, onClose, addCoins }) {
  ...
  return (
    ...
    >
      ...
      {/* Bottom Navbar (Mock) */}
      <div className="absolute bottom-0 left-0 right-0 h-16 bg-white border-t border-slate-100 flex items-center justify-around px-2 z-30 shadow-[0_-10px_20px_rgba(0,0,0,0.02)]">
