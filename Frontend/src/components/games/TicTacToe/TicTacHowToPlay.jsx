...
export default function TicTacHowToPlay({ onBack }) {
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center gap-3 p-5 bg-white shadow-sm z-10">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-3xl p-5 flex items-center gap-4 shadow-sm border border-slate-100">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 font-medium">Win games against the AI to earn Mynzo Coins and exclusive shopping coupons.</p>
            </div>
          </div>
