    ...
    >
      ...
      <div className="px-4 mb-8">
        <div className="bg-[#071226] rounded-2xl p-1 flex items-stretch shadow-md overflow-hidden relative">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-lg z-10 text-[10px] font-black text-slate-800">
            VS
          </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="w-full aspect-square bg-white rounded-3xl shadow-[0_0_40px_rgba(0,0,0,0.05)] p-4 relative border border-slate-100">
          ...
          <div className="absolute inset-4 pointer-events-none">
            <div className="absolute top-1/3 left-0 w-full h-[2px] bg-slate-100 rounded-full"></div>
            <div className="absolute top-2/3 left-0 w-full h-[2px] bg-slate-100 rounded-full"></div>
            <div className="absolute top-0 left-1/3 w-[2px] h-full bg-slate-100 rounded-full"></div>
            <div className="absolute top-0 left-2/3 w-[2px] h-full bg-slate-100 rounded-full"></div>
          </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex gap-4">
          <button 
            onClick={resetGame}
            className="flex-1 bg-white border border-slate-200 text-slate-700 font-bold text-sm py-4 rounded-2xl flex items-center justify-center gap-2 shadow-sm hover:bg-slate-50 active:scale-95 transition-all"
          >
