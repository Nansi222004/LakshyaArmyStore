    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {[...Array(6)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-2 h-8 bg-white/10 rounded-full rotate-45"
            initial={{ 
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center relative z-10 pt-10">
        ...
        <motion.div 
          ...
          className="w-40 aspect-square bg-white rounded-2xl p-2 relative shadow-[0_0_30px_rgba(255,255,255,0.1)] mb-10"
        >
        ...
        {(isWin || isDraw) && (
          ...
          >
            ...
            {isWin && (
              <div className="bg-white text-slate-800 px-4 py-3 rounded-2xl flex items-center gap-3">
      ...
      >
        <button
          ...
          className="flex-1 bg-white text-slate-800 font-black text-sm py-4 rounded-2xl hover:bg-slate-100 active:scale-95 transition-all"
        >
          PLAY AGAIN
        </button>
        <button
