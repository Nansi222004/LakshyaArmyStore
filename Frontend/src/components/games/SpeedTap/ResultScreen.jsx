  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="mt-12 bg-white text-slate-800 rounded-3xl p-6 relative z-10 shadow-[0_0_30px_rgba(255,255,255,0.1)] mx-2"
      >
      ...
      >
        ...
        <div className="flex gap-3">
          <button
            onClick={onPlayAgain}
            className="flex-1 bg-white/10 text-white border border-white/20 font-bold text-sm py-4 rounded-2xl hover:bg-white/20 active:scale-95 transition-all backdrop-blur-sm"
          >
            PLAY AGAIN
          </button>
          <button
