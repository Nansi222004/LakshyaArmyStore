    ...
    <footer className="bg-[#0F172A] text-slate-400 py-10 px-6 mt-10 border-t border-slate-800 text-sm mb-16">
      <div className="max-w-md mx-auto space-y-8">
        ...
        <div className="grid grid-cols-2 gap-6 text-xs">
          <div className="space-y-2">
            ...
            <ul className="space-y-1.5">
              <li><a href="#" className="hover:text-[#4B5320] transition-colors">Gift Hampers</a></li>
              <li><a href="#" className="hover:text-[#4B5320] transition-colors">Teddy Bears & Plush</a></li>
              <li><a href="#" className="hover:text-[#4B5320] transition-colors">RC Toys & Gadgets</a></li>
              <li><a href="#" className="hover:text-[#4B5320] transition-colors">Sterling Pendants</a></li>
            </ul>
          </div>
          <div className="space-y-2">
        ...
        <div className="flex items-center gap-2 bg-slate-800/40 p-3 rounded-xl border border-slate-800">
          <ShieldCheck className="w-5 h-5 text-[#4B5320] flex-shrink-0" />
