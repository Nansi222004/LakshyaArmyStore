...
firebase.initializeApp({
  ...
  authDomain: "lakshya-814fe.firebaseapp.com",
  projectId: "lakshya-814fe",
  storageBucket: "lakshya-814fe.firebasestorage.app",
...
messaging.onBackgroundMessage((payload) => {
  ...
  if (!payload.notification) {
    const notificationTitle = payload.data?.title || "Lakshya Notification";
    const notificationOptions = {
      body: payload.data?.body || "",
      icon: payload.data?.image || "/logo_lakshya.webp"
    };
